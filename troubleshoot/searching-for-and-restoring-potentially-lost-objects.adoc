...
+
*** Wählen Sie im Grid Manager die Option *Support* > *Tools* > *Grid Topology* aus. Wählen Sie dann *_Data Center_* > *_Storage Node_* > *LDR* aus. Die LDR-Knoten-ID befindet sich in der Node-Informationstabelle. Überprüfen Sie die Informationen für jeden Speicherknoten, bis Sie den gefunden haben, der dieses LDR hostet.
...
.. Setzen Sie die Anzahl der verlorenen Objekte im Grid Manager zurück.
...
link:troubleshooting-storagegrid-system.html["Bestätigen der Speicherorte von Objektdaten"]
