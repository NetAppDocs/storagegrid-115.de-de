...
NOTE: Die in der Tabelle für die Portkonnektivität aufgeführten Grid-Netzwerkports sind nur für StorageGRID Version 11.5 gültig. Um zu überprüfen, welche Ports für jeden Node-Typ korrekt sind, sollten Sie immer die Netzwerkrichtlinien für Ihre Version von StorageGRID lesen.
...
+
image::../media/nmap_test_table.png[Portverbindungstabelle]
