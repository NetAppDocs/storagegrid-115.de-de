...
** Wenn Sie auf die Mandantenmanagement-API zugreifen möchten, geben Sie die Mandantenkontokennung ein. +image:../media/sso_auth_python_script.png["SSO Authentifizierungsskript"]
...
== Wenn Single Sign-On aktiviert ist, wird die API von der API absigniert
