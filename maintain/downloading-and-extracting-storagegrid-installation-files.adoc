...
.Schritte
. Bestimmen Sie, welche Version der Software derzeit installiert ist. Gehen Sie vom Grid Manager zu *Hilfe* *über*.
...
| StorageGRID-Webscale-_version_-DEB-_uniqueID_.zip StorageGRID-Webscale-_Version_-DEB-_uniqueID_.tgz 
 ...
 a| 
OpenStack oder anderen Hypervisor
 a| 
...
. Wenn Sie ein VMware-System wiederherstellen, wählen Sie die entsprechenden Dateien aus.
+
[cols="1a,1a"]
|===
...
|===
. Wenn Sie ein Red hat Enterprise Linux oder CentOS System wiederherstellen, wählen Sie die entsprechenden Dateien aus.
+
[cols="1a,1a"]
|===
| Pfad und Dateiname | Beschreibung 
...
|===
. Wenn Sie ein Ubuntu oder Debian-System wiederherstellen, wählen Sie die entsprechenden Dateien aus.
+
[cols="1a,1a"]
|===
| Pfad und Dateiname | Beschreibung 
