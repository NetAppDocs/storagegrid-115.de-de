...
* link:considerations-and-requirements-for-appliance-node-cloning.html["Überlegungen und Anforderungen zum Klonen von Appliance-Nodes"]
+
...
.Schritte
. Platzieren Sie den Quellknoten, den Sie klonen, in den Wartungsmodus.
+
