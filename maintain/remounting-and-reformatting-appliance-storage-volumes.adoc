...
. Kehren Sie zur Seite „Installation überwachen“ des Installationsprogramms für StorageGRID-Geräte zurück, indem Sie eingeben `\http://Controller_IP:8080`, Verwendung der IP-Adresse des Compute-Controllers.
+
