...
NOTE: Wenn diese Optionen nicht verfügbar sind oder die Anmeldeseite des SANtricity System Managers nicht angezeigt wird, rufen Sie den SANtricity System Manager auf, indem Sie die Storage-Controller-IP aufrufen: +
...
+
.. Wählen Sie im SANtricity System Manager die Option *Support* > *Upgrade Center* aus.
