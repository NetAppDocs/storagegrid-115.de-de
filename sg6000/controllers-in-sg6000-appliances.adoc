...
summary: Jedes Modell der StorageGRIDSG6000 Appliance umfasst je nach Modell einen SG6000-CN Computing Controller in einem 1-HE-Gehäuse und E-Series Duplex Storage-Controller in einem 2-HE- oder 4-HE-Gehäuse. In den Diagrammen erfahren Sie mehr über die einzelnen Controller-Typen. 
---
...
| Verbinden Sie jeden der E2800 Controller mit dem SG6000-CN Controller. Es sind vier Verbindungen zum SG6000-CN Controller vorhanden (zwei von jedem E2800). 
